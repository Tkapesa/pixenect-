  ...
  return (
    <main className="app-root">
      ...
      <section className="vhero rewrite-hero" id="home" aria-label="Hero">
        ...
        <video className="vhero-video" autoPlay muted loop playsInline preload="auto" poster={`${import.meta.env.BASE_URL}hero-bg.jpg`} aria-hidden="true">
      ...
      <section className="cta-section rewrite-cta" id="contact"><div className="cta-inner" data-reveal><div className="eyebrow cta-ew">Start with clarity</div><h2 className="cta-h">Ready to stop managing four vendors and start with one team?</h2><p className="cta-blurb">Book a 30-minute strategy call. You will leave with a clear view of what your digital presence needs, whether or not you decide to work with us.</p><a href="mailto:info@pixenect.com?subject=Strategy%20Call" className="cta-contact-btn">Book a Strategy Call <i className="ti ti-arrow-up-right" aria-hidden="true" /></a><div className="cta-details"><a href="mailto:info@pixenect.com" className="cta-detail"> info@pixenect.com</a><span className="cta-bull" aria-hidden="true">·</span><a href="tel:+905338866227" className="cta-detail">+90 533 886 6227</a></div></div></section>

      <footer className="site-footer"><div className="footer-cta-band" data-reveal><div className="footer-cta-text"><p className="footer-cta-eyebrow">Digital partner</p><h2 className="footer-cta-heading">Design, build, and growth<br />as one system.</h2></div><a href="#contact" className="footer-cta-action">Book a Strategy Call <i className="ti ti-arrow-up-right" aria-hidden="true" /></a></div><div className="footer-shell" data-reveal><section className="footer-brand-col" aria-label="Company details and contact"><div className="footer-brand-name" aria-label="Pixenect logo"><img src={footerLogo} alt="Pixenect logo" width="194" height="45" className="footer-brand-logo" /></div><p className="footer-brand-copy">A single, accountable team for businesses that need their digital presence to bring in business.</p><div className="footer-contact-lines"><a href="mailto:info@pixenect.com"> info@pixenect.com</a><span className="footer-contact-sep" aria-hidden="true">|</span><a href="tel:+905338866227">+90 533 886 6227</a></div></section><section className="footer-links-grid" aria-label="Footer navigation"><div className="footer-link-col"><h3>Explore</h3><a href="#services">Services</a><a href="#process">How We Work</a><a href="#faq">FAQ</a><a href="#contact">Contact</a></div><div className="footer-link-col"><h3>Services</h3><Link to="/services/ui-ux-design">Web Design</Link><Link to="/services/web-development">Web Development</Link><Link to="/services/brand-identity">Brand Identity</Link><Link to="/services/growth-seo">Growth &amp; SEO</Link></div><div className="footer-link-col"><h3>Company</h3><Link to="/about">About Pixenect</Link><Link to="/process">Project Process</Link><Link to="/privacy">Privacy Policy</Link></div></section></div><div className="footer-bottom"><div className="footer-copy">&copy; 2026 PIXENECT. ALL RIGHTS RESERVED.</div><div className="footer-socials" aria-label="Social links"><a href="https://www.instagram.com/" target="_blank" rel="noreferrer" aria-label="Instagram"><i className="ti ti-brand-instagram" aria-hidden="true" /></a><a href="#" aria-label="LinkedIn"><i className="ti ti-brand-linkedin" aria-hidden="true" /></a></div></div></footer>
      <section className="cta-section rewrite-cta" id="contact"><div className="cta-inner" data-reveal><div className="eyebrow cta-ew">Start with clarity</div><h2 className="cta-h">Ready to stop managing four vendors and start with one team?</h2><p className="cta-blurb">Book a 30-minute strategy call. You will leave with a clear view of what your digital presence needs, whether or not you decide to work with us.</p><a href="mailto:info@pixenect.com?subject=Strategy%20Call" className="cta-contact-btn">Book a Strategy Call <i className="ti ti-arrow-up-right" aria-hidden="true" /></a><div className="cta-details"><a href="mailto:info@pixenect.com" className="cta-detail">info@pixenect.com</a><span className="cta-bull" aria-hidden="true">·</span><a href="tel:+905428861113" className="cta-detail">+90 542 886 1113</a></div></div></section>

      <footer className="site-footer"><div className="footer-cta-band" data-reveal><div className="footer-cta-text"><p className="footer-cta-eyebrow">Digital partner</p><h2 className="footer-cta-heading">Design, build, and growth<br />as one system.</h2></div><a href="#contact" className="footer-cta-action">Book a Strategy Call <i className="ti ti-arrow-up-right" aria-hidden="true" /></a></div><div className="footer-shell" data-reveal><section className="footer-brand-col" aria-label="Company details and contact"><div className="footer-brand-name" aria-label="Pixenect logo"><img src={footerLogo} alt="Pixenect logo" width="194" height="45" className="footer-brand-logo" /></div><p className="footer-brand-copy">A single, accountable team for businesses that need their digital presence to bring in business.</p><div className="footer-contact-lines"><a href="mailto:info@pixenect.com">info@pixenect.com</a><span className="footer-contact-sep" aria-hidden="true">|</span><a href="tel:+905428861113">+90 542 886 1113</a></div></section><section className="footer-links-grid" aria-label="Footer navigation"><div className="footer-link-col"><h3>Explore</h3><a href="#services">Services</a><a href="#process">How We Work</a><a href="#faq">FAQ</a><a href="#contact">Contact</a></div><div className="footer-link-col"><h3>Services</h3><Link to="/services/ui-ux-design">Web Design</Link><Link to="/services/web-development">Web Development</Link><Link to="/services/brand-identity">Brand Identity</Link><Link to="/services/growth-seo">Growth &amp; SEO</Link></div><div className="footer-link-col"><h3>Company</h3><Link to="/about">About Pixenect</Link><Link to="/process">Project Process</Link><Link to="/privacy">Privacy Policy</Link></div></section></div><div className="footer-bottom"><div className="footer-copy">&copy; 2026 PIXENECT. ALL RIGHTS RESERVED.</div><div className="footer-socials" aria-label="Social links"><a href="#" aria-label="Instagram"><i className="ti ti-brand-instagram" aria-hidden="true" /></a><a href="#" aria-label="LinkedIn"><i className="ti ti-brand-linkedin" aria-hidden="true" /></a></div></div></footer>
    </main>
  );
}
